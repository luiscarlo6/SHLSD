...
public class Consulta_acreditaciones extends javax.swing.JFrame {
  ...
  public Consulta_acreditaciones(B_A_estudiante estudiante) {
   ...
   * @param carnet
   */
  public Consulta_acreditaciones() {
    initComponents();
  }
  //constructor
  public Consulta_acreditaciones(Integer carnet_entrada) {
  ...
  @SuppressWarnings("unchecked")
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Consultar las acreditaciones de un estudiante");
        ...
        jLabel5.setText("Acreditaciones");
        ...
        jList1.setModel(new javax.swing.AbstractListModel() {
            String[] strings = B_A_horas.consultarLaboresStrings(estudiante.getCarnet());
  ...
  public static void main(String args[]) {
    ...
    try {
      ...
      java.util.logging.Logger.getLogger(Consulta_acreditaciones.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    java.awt.EventQueue.invokeLater(new Runnable() {
      public void run() {    
        new Consulta_acreditaciones().setVisible(true);
      }
