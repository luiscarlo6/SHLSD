...
public class B_A_horas {
    ...
    public String toString() {
        return "Carnet: " + carnet + ", hora_fin: " + hora_fin.toString() + ", hora_inicio: " + hora_inicio.toString() + ", observaciones: " + observaciones + ", tiempo_total: " + tiempo_total + ", fecha: " + fecha ;
    }
    ...
    public void registrarLabor(){
        try (Connection conn = Conexion.obtenerConn()) {
            ...
            st.execute("INSERT INTO LABOR values ('" + this.getHora_inicio().getCadena() + "', '"
