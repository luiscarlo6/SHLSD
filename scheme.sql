...
CREATE TABLE ESTUDIANTE
  ( NOMBRE     VARCHAR(30) NOT NULL, --NOMBRES DEL ESTUDIANTE
    ...
    CARNET     INTEGER     NOT NULL, --CARNET DEL ESTUDIANTE EJ. 12-34567
    ...
    ACUMULADO  FLOAT(24)   NOT NULL, --TOTAL DE HORAS ACUMULADAS DEL SERVICIO COMUNITARIO
...
CREATE TABLE LABOR
  ( SERIE         SERIAL      NOT NULL, --IDENTIFICADOR
    ...
    CARNET_LABOR  INTEGER     NOT NULL, --CARNET IDENTIFICADOR DEL ESTUDIANTE
    TIEMPO_TOTAL  FLOAT(24)   NOT NULL, --TIEMPO ACREDITADO POR LA LABOR SOCIAL
